...
[![Build Status](https://github.com/cosmos/gosec/workflows/CI/badge.svg)](https://github.com/cosmos/gosec/actions?query=workflows%3ACI)
[![Coverage Status](https://codecov.io/gh/cosmos/gosec/branch/master/graph/badge.svg)](https://codecov.io/gh/cosmos/gosec)
[![GoReport](https://goreportcard.com/badge/github.com/cosmos/gosec)](https://goreportcard.com/badge/github.com/cosmos/gosec)
[![GoDoc](https://godoc.org/github.com/cosmos/gosec?status.svg)](https://godoc.org/github.com/cosmos/gosec)
...
curl -sfL https://raw.githubusercontent.com/cosmos/gosec/master/install.sh | sh -s -- -b $(go env GOPATH)/bin vX.Y.Z

# or install it into ./bin/
curl -sfL https://raw.githubusercontent.com/cosmos/gosec/master/install.sh | sh -s vX.Y.Z

# In alpine linux (as it does not come with curl by default)
wget -O - -q https://raw.githubusercontent.com/cosmos/gosec/master/install.sh | sh -s vX.Y.Z

# If you want to use the checksums provided on the "Releases" page
# then you will have to download a tar.gz file for your operating system instead of a binary file
wget https://github.com/cosmos/gosec/releases/download/vX.Y.Z/gosec_vX.Y.Z_OS.tar.gz
...
```bash
go get github.com/cosmos/gosec/v2/cmd/gosec
```
...
Every issue detected by `gosec` is mapped to a [CWE (Common Weakness Enumeration)](http://cwe.mitre.org/data/index.html) which describes in more generic terms the vulnerability. The exact mapping can be found  [here](https://github.com/cosmos/gosec/blob/master/issue.go#L49).
...
```bash
docker run --rm -it -w /<PROJECT>/ -v <YOUR PROJECT PATH>/<PROJECT>:/<PROJECT> cosmos/gosec /<PROJECT>/...
```
...
```bash
go get github.com/cosmos/gosec/v2/cmd/tlsconfig/...
```
